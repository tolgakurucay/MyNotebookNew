    ...
    CloudContent(state = state,
        onNoteItemClicked = { noteModel ->
            if (state.isShowingTheMenu.not()) {
                ...
                cloudViewModel.doSelectableOrNot(noteModel.copy(isSelected = noteModel.isSelected.not()))
            }
        },
        ...
        onTopBarActionsClicked = {
            when (it) {
                ...
                is CloudTopBarActions.Search -> cloudViewModel.searchNotesByText(it.searchString)
