...
class AddNoteToRemote @Inject constructor(private val repo: HomeRepository): BaseUseCase() {

    suspend operator fun invoke(noteModel: NoteModel) = executeFlow(repo.addNoteToRemote(noteModel))
